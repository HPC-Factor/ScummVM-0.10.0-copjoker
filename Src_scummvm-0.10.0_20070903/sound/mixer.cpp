 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-0-10-0/sound/mixer.cpp $
 * $Id: mixer.cpp 27066 2007-06-03 15:56:14Z fingolfin $
 *
 */
...
void Channel::mix(int16 *data, uint len) {
	...
	if (_input->endOfData()) {
		...
		printf("COP:Channel:Mix - endOfData() : endOfStream??? %s\n", _input->endOfStream() ? "TRUE" : "FALSE");
	} else {
		assert(_converter);
