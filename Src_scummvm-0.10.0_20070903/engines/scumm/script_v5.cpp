 ...
 *
 * $URL: https://scummvm.svn.sourceforge.net/svnroot/scummvm/scummvm/tags/release-0-10-0/engines/scumm/script_v5.cpp $
 * $Id: script_v5.cpp 27024 2007-05-30 21:56:52Z fingolfin $
 *
 */
...
void ScummEngine_v5::o5_add() {
	...
	if(_useCJKMode) {
		if(_game.id == GID_MONKEY2 && _resultVarNumber == 176 && a == 8) {
			a = _2byteHeight + 1;
		}
		if(_game.id == GID_MONKEY_VGA && _resultVarNumber == 228 && a == 8) {
			a = _2byteHeight + 1;
		}
		if(_game.id == GID_MONKEY && _resultVarNumber == 229 && a == 8) {
			a = _2byteHeight + 1;
		}
	}
#endif 
